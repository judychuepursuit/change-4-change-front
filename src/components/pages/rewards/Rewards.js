    ...
    <div className="rewards-page">
      ...
      <section className="reward-intro">
        ...
        <p className="reward-pg">
          Empower change with our revolutionary charity rewards! Earn badges,
          unlock exclusive perks, and channel your generosity toward causes
          you're passionate about. Join a vibrant community dedicated to making
          a lasting impact. Earn points based on each recorded purchase.
        </p>
